...
parser.add_argument("--social", default=3, type=float, help="Social parameter")
...
#Booth
try: 
    with open('SuperHighPhiBooth.csv', 'x', newline='') as output_file:
        writer_object = writer(output_file)
        writer_object.writerow(row_labels)
        output_file.close()       
except:
    pass
with open('SuperHighPhiBooth.csv','a+', newline='') as f_object:
...
#Rosenbrock
try: 
    with open('SuperHighPhiRosenbrock.csv', 'x', newline='') as output_file:
        writer_object = writer(output_file)
        writer_object.writerow(row_labels)
        output_file.close()        
except:
    pass
with open('SuperHighPhiRosenbrock.csv','a+', newline='') as f_object:
    writer_object = writer(f_object)
