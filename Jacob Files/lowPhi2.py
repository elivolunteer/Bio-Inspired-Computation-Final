...
#Booth
try: 
    with open('LowPhiBooth.csv', 'x', newline='') as output_file:
        writer_object = writer(output_file)
        writer_object.writerow(row_labels)
        output_file.close()       
except:
    pass
with open('LowPhiBooth.csv','a+', newline='') as f_object:
...
#Rosenbrock
try: 
    with open('LowPhiRosenbrock.csv', 'x', newline='') as output_file:
        writer_object = writer(output_file)
        writer_object.writerow(row_labels)
        output_file.close()        
except:
    pass
with open('LowPhiRosenbrock.csv','a+', newline='') as f_object:
    writer_object = writer(f_object)
